...
function next() {
  localStorage.t = (Number(localStorage.t) || 0) + Math.floor(Math.random() * 360);
...
function crosses(id, fg, bg) {
  ...
  return [
    'background: ' + [
      'radial-gradient(circle, transparent 20%, ' + bg + ' 20%, ' + bg + ' 80%, transparent 80%, transparent)',
      'radial-gradient(circle, transparent 20%, ' + bg + ' 20%, ' + bg + ' 80%, transparent 80%, transparent) ' + size + 'px ' + size + 'px',
      'linear-gradient(' + fg + ' ' + primary + 'px, transparent ' + primary + 'px) 0 -' + secondary + 'px',
      'linear-gradient(90deg, ' + fg + ' ' + primary + 'px, transparent ' + primary + 'px) -' + secondary + 'px 0'
    ].join(', '),
    'background-color: ' + bg,
    'background-size: ' + [
      dbl + 'px ' + dbl + 'px',
...
function zigzag(id, fg, bg) {
  ...
  return [
    'background:' + [
      'linear-gradient(135deg, ' + fg + ' 25%, transparent 25%) -' + size + 'px 0',
      'linear-gradient(225deg, ' + fg + ' 25%, transparent 25%) -' + size + 'px 0',
